<section class="bg-white border-top mt-auto" id="ohari5336_policy" style="display: none;">
    <div class="container">
...
<section class="bg-dark py-5 text-light footer-widget" id="ohari5336_footer_menu">
    <div class="container">
        <div class="row">
                ...
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="44" style="height: 150px;">
                        @else
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="44" style="height: 150px;">
                        @endif
                    </a>
                    <div class="my-3">
        ...
        @if(false)
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0" id="ohari5336_footer_menu_contact_info">
            ...
            <div class="col-md-4 col-lg-2" id="ohari5336_footer_menu_my_account">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-13 text-uppercase fw-600 border-bottom border-gray-900 pb-2 mb-4">
...
@media screen and (max-width: 600px) {
  #ohari5336_footer_menu_my_account {
    visibility: hidden;
    display: none;
  }
  
  #ohari5336_footer_menu_contact_info {
    visibility: hidden;
    display: none;
  }
}
