                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    @auth
                        ...
                        @else
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('dashboard') }}" class="text-reset d-inline-block opacity-60">{{ translate('My Profile')}}</a>
                            </li>
                        @endif
                    ...
                    @else
                        <div class="col-4 text-right d-none d-lg-block p-3">
                            <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                                <li class="list-inline-item mr-3 pr-3 border-left-0 pl-0">
                                    <a href="{{ route('user.login') }}" class="text-reset d-inline-block btn btn-sm btn-login btn-primary">
                                        {{ translate('Login') }}
                                    </a>
                                </li>&nbsp; &nbsp;
                                <li class="list-inline-item">
                                    <a href="{{ route('user.registration') }}" class="text-reset d-inline-block btn btn-sm btn-register">
                                        {{ translate('Signup') }}
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="list-inline-item">
                            <a href="{{ route('user.registration') }}" class="text-reset d-inline-block opacity-60">{{-- translate('Signup') --}}</a>
                        </li>-->
                    @endauth
                </ul>
            </div>
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40" style="height:80px;">
                        @endif
                    </a>

                    @if(Route::currentRouteName() != 'home')
                        <div class="d-none d-xl-block align-self-stretch category-menu-icon-box ml-auto mr-0" style="display:none;">
                            <div class="h-100 d-flex align-items-center" id="category-menu-icon" style="display:none;">
                                <div class="dropdown-toggle navbar-light bg-light h-40px w-50px pl-2 rounded border c-pointer" style="display:none;">
                ...
                <div class="d-lg-none ml-auto mr-0" style="display:none;">
                ...
                <div class="d-none d-lg-block ml-3 mr-0" style="display:none;">
                    <div class="" id="wishlist" style="display:none;">
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="bg-white border-top border-gray-200 py-1" id="ohari5336_menu">
            <div class="container">
