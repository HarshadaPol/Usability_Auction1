...
<head>
    ...
    <style>
        ...
        .btn-login:hover {
            ...
            color: #e22b61 !important;
        }

        .btn-register {
            height: 40px;
            width: 150%;
            border: 2px solid #e22b61;
        }

        .btn-register:hover {
            background-color: #e22b61;
            color: white;
        }
        ...
        .dis_section {
            ...
            top: 0px;
            left: 0px;
            background: url(https://www.jiomart.com/assets/version1633025089/smartweb/images/icons/offer_bg.svg) center no-repeat;
            font-size: 11px;
