            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card" style="border-radius: 1.25rem!important;">
                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        @if (addon_is_activated('otp_system'))
                                            ...
                                            <div class="form-group text-right">
                                                <button class="btn btn-link p-0 opacity-90 text-reset" type="button" onclick="toggleEmailPhone(this)">{{ translate('Use Email Instead') }}</button>
                                            </div>
                                        @else
                                            <div class="form-group">
...
iti.setCountry("in");
        ...
        $('#ohari5336_menu').hide();
        $('#ohari5336_counter').hide();
        $('#ohari5336_policy').hide();
        $('#ohari5336_footer_menu').hide();
    </script>
@endsection
