                ...
                <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_shipping_infostore') }}" role="form" method="POST">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-center text-md-right">
                            ...
                            <br>
                            <span class="error" id="opin_error"></span>
                        </div>
                    </div>
                </form>
            </div>
...
@section('script')
    <script type="text/javascript">
        ...
        @if(Session::has('pincode') && Session::get('pincode'))
            $('#ohari_pin').prop('disabled', false);
        @else
            $('#ohari_pin').prop('disabled', true);
            $('#opin_error').text("Please enter valid Pincode on top box.");
        @endif
