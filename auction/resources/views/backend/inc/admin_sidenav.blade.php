...
@if(false)
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('pincode.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pincode.index'])}}">
                        <i class="las la-map aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Pincode')}}</span>
                    </a>
                </li>
