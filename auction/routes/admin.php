...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/pincode/destroy/{id}', 'PincodeController@destroy')->name('pincode.destroy');
    Route::post('/pincode/status', 'PincodeController@updateStatus')->name('pincode.status');
